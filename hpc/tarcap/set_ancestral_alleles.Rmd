...
This is the bioinformatic pipeline of Lau et al., analysing the target capture sequencing reads of ddRAD loci in the Antarctic octopus Pareledone turqueti. For link to the publication see <DOI>. 

## Set ancestral alleles for P. turqueti
See https://github.com/jessstapley/Set_ancestral_allele_vcf for complete tutorial
<br>
Keep outgroup samples (Pareledone cornuta: CT931, Pareledone aequipapillae: 44064_1)
...
```
Create a table with ancestral allele information. If the site is not identical across both outgroups, then  record it as missing, i.e. '.'
```{bash, error=TRUE, results='hide'}
