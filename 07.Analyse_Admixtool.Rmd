...
Generate simulated SNPs for best complex model with WAIS collapse (_pscc_fulcol1_) and simpler models with no (_psc_nocol_) or partial (_psc_parcol_) WAIS collapse 
<br>
<br>
...
```
<br>
See hpc/admixtools/simulated in this repo for scripts ussed for analysis of simulated data with Admixtools (e.g. "modelname".geno)
