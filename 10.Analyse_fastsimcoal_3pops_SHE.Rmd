---
title: "Demographic modelling with Fastsimcoal 3 populaitons"
...
<br>
See hpc/fastsimcol_3pops_SHE/models in this repo for corresponding .est and .tpl files  
<br>
...
For each tested model, run scripts within ./hpc/fastsimcoal_3pops_SHE/FitToObservedSFS_seaway  
e.g. SHE_WSRS  
```{bash, error=TRUE, results='hide', eval=FALSE}
